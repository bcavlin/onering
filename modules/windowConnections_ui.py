...
class Ui_MainWindow_connections(object):
    def setupUi(self, MainWindow_connections):
        ...
        self.pushButton_filter = QtGui.QPushButton(self.groupBox)
        self.pushButton_filter.setObjectName(_fromUtf8("pushButton_filter"))
        self.horizontalLayout_4.addWidget(self.pushButton_filter)
        ...
        MainWindow_connections.setTabOrder(self.filterLineEdit, self.pushButton_filter)
        MainWindow_connections.setTabOrder(self.pushButton_filter, self.tableView_netstat)
    ...
    def retranslateUi(self, MainWindow_connections):
        ...
        self.filterLabel.setText(_translate("MainWindow_connections", "Expression", None))
        self.filterLineEdit.setPlaceholderText(_translate("MainWindow_connections", "Filter text (all columns are searched)", None))
        self.pushButton_filter.setText(_translate("MainWindow_connections", "Filter", None))
