...
class Ui_MainWindow_firewall(object):
    def setupUi(self, MainWindow_firewall):
        ...
        MainWindow_firewall.resize(796, 577)
        font = QtGui.QFont()
        ...
        self.label_status = QtGui.QLabel(self.groupBox_2)
        self.label_status.setTextFormat(QtCore.Qt.AutoText)
        self.label_status.setObjectName(_fromUtf8("label_status"))
        self.verticalLayout.addWidget(self.label_status)
        self.label_logging = QtGui.QLabel(self.groupBox_2)
        self.label_logging.setObjectName(_fromUtf8("label_logging"))
        self.verticalLayout.addWidget(self.label_logging)
        self.label_default = QtGui.QLabel(self.groupBox_2)
        self.label_default.setObjectName(_fromUtf8("label_default"))
        self.verticalLayout.addWidget(self.label_default)
    ...
    def retranslateUi(self, MainWindow_firewall):
        ...
        self.label_status.setText(_translate("MainWindow_firewall", "<html><head/><body><p>Status: <span style=\" font-weight:600; color:#00007f;\">n/a</span></p></body></html>", None))
        self.label_logging.setText(_translate("MainWindow_firewall", "<html><head/><body><p>Logging level: <span style=\" font-weight:600; color:#00007f;\">n/a</span></p></body></html>", None))
        self.label_default.setText(_translate("MainWindow_firewall", "<html><head/><body><p>Default: <span style=\" font-weight:600; color:#00007f;\">n/a</span></p></body></html>", None))
