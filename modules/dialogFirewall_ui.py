...
class Ui_DialogFirewall(object):
    def setupUi(self, DialogFirewall):
        ...
        DialogFirewall.setTabOrder(self.pushButton_refresh, self.pushButton_insert)
        DialogFirewall.setTabOrder(self.pushButton_insert, self.pushButton_remove)
        DialogFirewall.setTabOrder(self.pushButton_remove, self.pushButton_enabled)
        DialogFirewall.setTabOrder(self.pushButton_enabled, self.tableWidget)
    ...
    def retranslateUi(self, DialogFirewall):
        ...
        self.pushButton_insert.setText(_translate("DialogFirewall", "Insert Rule", None))
        self.pushButton_remove.setText(_translate("DialogFirewall", "Remove Rule", None))
        self.pushButton_enabled.setText(_translate("DialogFirewall", "Disable", None))
