...
class Ui_DialogFirewall(object):
    def setupUi(self, DialogFirewall):
        ...
        DialogFirewall.setTabOrder(self.pushButton_enabled, self.pushButton_refresh)
        DialogFirewall.setTabOrder(self.pushButton_refresh, self.pushButton_remove)
        DialogFirewall.setTabOrder(self.pushButton_remove, self.tableWidget)
